...
describe("SpawnService.readLogTail", () => {
  it.scoped("returns '(no log file found)' for nonexistent file", () =>
    Effect.gen(function* () {
  ...
  it.scoped("returns last N lines of file", () =>
    Effect.gen(function* () {
  ...
  it.scoped("returns all content if fewer lines than requested", () =>
    Effect.gen(function* () {
...
describe("SpawnService.getExitCodeFromLog", () => {
  it.scoped("returns null for nonexistent file", () =>
    Effect.gen(function* () {
  ...
  it.scoped("returns null for file without exit code marker", () =>
    Effect.gen(function* () {
  ...
  it.scoped("returns 0 for __EXIT_CODE__=0", () =>
    Effect.gen(function* () {
  ...
  it.scoped("returns exit code from end of file", () =>
    Effect.gen(function* () {
...
describe("SpawnService.spawnDetached", () => {
  it.scoped("spawns a detached process and returns PID", () =>
    Effect.gen(function* () {
...
describe("SpawnService.loadEnvFile", () => {
  it.scoped("returns empty object for nonexistent file", () =>
    Effect.gen(function* () {
  ...
  it.scoped("parses key=value pairs", () =>
    Effect.gen(function* () {
  ...
  it.scoped("handles values with equals signs", () =>
    Effect.gen(function* () {
